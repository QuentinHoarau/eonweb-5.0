...
<div id="page-wrapper">
	...
	<form id="tool-form">
		<div class="row">
			<div class="row col-md-5">
				...
				<div id="snmp">
					<div id="v1" class="form-group col-md-12">
				...
				<div id="port" class="row form-group col-md-12">
			...
			<div class="col-md-7">
				<!-- Loading message -->
				<div id="loading"><?php echo getLabel("message.loading"); ?></div>
	...
	<!-- Loading message -->
	<div id="loading_snmp"><?php echo getLabel("message.loading"); ?></div>
	
	<!-- SNMP Result here ! -->
	<div id="result_snmp"></div>
